...
explainers <- list(
  ...
  list(name = "Structural Topic Models", url = "stm-explainer.html", image = "media/wordcloud_stm.png"),
  list(name = "Robust Design Mark-Recapture", url = "https://deonroos.github.io/Robust_Design/", image = "media/warbler.png")
)
